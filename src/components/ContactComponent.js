...
class Contact extends Component {
    ...
    validate(firstname, lastname, email, telnum) {
        ...
        const reg = /^\d+$/; // regular expersions if the string ccontains only, numbers
                    ...
                    <div className="col-12 col-md-9">
                        <Form onSubmit={this.handleSubmit}>
                            ...
                            <FormGroup row>
                                ...
                                <Col md={10}>
                                    <Input type="text" id="email" name='email' placeholder='Email' value={this.state.email} valid= {errors.email ===''} invalid={errors.email !==''} onChange={this.handleInputChange} onBlur={this.handleBlur('email')}  />
